...
- Network
- VPN
img: https://images.icloudnative.io/uPic/202111101345322.png
---

![](https://images.icloudnative.io/uPic/202111101352665.jpeg)
...
![](https://images.icloudnative.io/uPic/202111061845425.png)
...
![](https://images.icloudnative.io/uPic/202111061929782.png)

创建完成后，还可以继续修改该网络的相关元数据，比如**允许节点在不使用秘钥的情况下加入 VPN 网络**。

![](https://images.icloudnative.io/uPic/202111062158090.png)

## 加入节点

如果部署 Netmaker 时开启了环境变量 `CLIENT_MODE: "on"`，Netmaker 就会将自身所在的主机也作为一个网络节点，名字默认为 `netmaker`。

![](https://images.icloudnative.io/uPic/202111062215376.jpg)
...
![](https://images.icloudnative.io/uPic/202111062216547.webp)

批准之后就可以看到两个节点之间已经握手成功了。

![](https://images.icloudnative.io/uPic/202111062246656.png)
...
![](https://images.icloudnative.io/uPic/202111071706395.png)
...
![](https://images.icloudnative.io/uPic/202111071940467.png)

当然，在创建 External Client 之前，需要先设置其中一个节点为 Ingress Gateway。

![](https://images.icloudnative.io/uPic/202111071937462.png)
...
![](https://images.icloudnative.io/uPic/202111071820971.png)

填写局域网的网段和出口网卡，如果你有多个网段需要打通（比如 OpenWrt 上的容器网段），可以用 "," 隔开。

![](https://images.icloudnative.io/uPic/202111071828160.png)

配置完成后，就会在 OpenWrt 节点配置的 Postup 和 Postdown 中添加相关的 iptables 规则。

![](https://images.icloudnative.io/uPic/202111071836056.png)
...
![](https://images.icloudnative.io/uPic/202111071842208.png)
