...
![Istio服务网格中的网关](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting6@main/uPic/gateways.svg "Istio服务网格中的网关")

其中 `Gateway` 是一个独立于平台的抽象，用于对流入专用中间设备的流量进行建模。下图描述了跨多个配置资源的控制流程。

![不同v1alpha3元素之间的关系](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting6@main/uPic/virtualservices-destrules.svg "不同v1alpha3元素之间的关系")
...
![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting6@main/uPic/aV9pPs.jpg)
