...
![](https://images.icloudnative.io/uPic/RgKVkq.jpg)
...
![](https://images.icloudnative.io/uPic/0lUjJX.jpg)

在模拟后台作业期间，对 API 资源 `/slow` 的访问速率达到了每秒 `3500` 个请求，影响到了其他端点和客户端。

![](https://images.icloudnative.io/uPic/a0lsWP.jpg)
...
![](https://images.icloudnative.io/uPic/1t4fwm.jpg)
...
![](https://images.icloudnative.io/uPic/vucp1T.jpg)

![](https://images.icloudnative.io/uPic/nqODKP.jpg)

![](https://images.icloudnative.io/uPic/JE0hom.jpg)
...
![](https://images.icloudnative.io/uPic/mVfHPN.jpg)
...
![](https://images.icloudnative.io/uPic/CTswvz.jpg)
...
![](https://images.icloudnative.io/uPic/h6cYkM.jpg)

通过可视化 API 服务实际看到的请求数量，可以证明请求速率在 `500个请求/秒` 上下波动，这正是我们所期望的！

![](https://images.icloudnative.io/uPic/FHBjiF.jpg)

再查看一下 Envoy 传出的 API 连接，可以看到传出请求速率也在 `500个请求/秒` 上下波动！

![](https://images.icloudnative.io/uPic/F0WQMW.jpg)
