...
![创建引导主机、控制平面和计算节点](https://images.icloudnative.io/uPic/20200602195135.png)
...
![](https://images.icloudnative.io/uPic/20200605130737.png)
    
② 选择一个『数据存储』，然后在右边的窗口中选择『上载文件』。

![](https://images.icloudnative.io/uPic/20200605131505.png)
...
![](https://images.icloudnative.io/uPic/20200605134815.png)
...
![](https://images.icloudnative.io/uPic/20200605150947.png)

然后找到 `OAuth`，点击进入，然后添加 `HTPasswd` 类型的 `Identity Providers`，并上传 `users.htpasswd` 文件。

![](https://images.icloudnative.io/uPic/20200605151307.png)

④ 退出当前用户，注意要退出到如下界面：

![](https://images.icloudnative.io/uPic/20200605151646.png)
...
![](https://images.icloudnative.io/uPic/20200605152528.png)

![](https://images.icloudnative.io/uPic/20200605152729.png)

![](https://images.icloudnative.io/uPic/20200605152911.png)

![](https://images.icloudnative.io/uPic/20200605153048.png)
