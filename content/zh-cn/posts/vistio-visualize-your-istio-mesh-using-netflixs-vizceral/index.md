...
![](https://images.icloudnative.io/uPic/QLT35D.jpg)
...
![](https://images.icloudnative.io/uPic/81eYoC.jpg)
...
![](https://images.icloudnative.io/uPic/r6foLP.jpg)
...
![](https://images.icloudnative.io/uPic/mA3qxn.jpg)

### 访问 Vistio

如果一切都已经启动并准备就绪，您就可以访问 Vistio UI，开始探索服务网格网络，访问`http://vistio-web.istio.io` 您将会看到类似下图的输出。

![](https://images.icloudnative.io/uPic/zO6YHU.jpg)
...
![](https://images.icloudnative.io/uPic/vInWWw.jpg)

在你的 Istio 网格中，您可以使用许多可视化工具来帮助您查明故障的应用程序。

![](https://images.icloudnative.io/uPic/p3Rf9a.jpg)
...
![](https://images.icloudnative.io/uPic/7N7vFf.jpg)
