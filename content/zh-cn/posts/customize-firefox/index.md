...
- Firefox
categories: tech
img: https://images.icloudnative.io/uPic/Mozilla-Foundation-accepts-Dogecoin-DOGE-users-threaten-to-stop-using.jpg
---

![](https://images.icloudnative.io/uPic/2022-04-30-cnfjg.png)
...
![](https://images.icloudnative.io/uPic/2022-04-29-20-14-RzmddG.png)

Chrome 有这个可能吗？

再比如我可以将 Firefox 的地址栏做成如下炫酷的特效，还可以将标签页的样式改造成如下的“花里胡哨”的样式：

![](https://images.icloudnative.io/uPic/2022-04-29-22-49-agMPpf.png)
...
![](https://images.icloudnative.io/uPic/2022-04-30-00-28-cueVKu.png)
...
![](https://images.icloudnative.io/uPic/2022-04-30-00-33-63s4XI.png)
...
@-moz-document url("chrome://browser/content/aboutDialog.xhtml") {
  ...
  #leftBox {
    background-image: url("https://images.icloudnative.io/uPic/20210505152049.png") !important;
...
+ [Photon Australis](https://github.com/wilfredwee/photon-australis) : 模仿 Chrome 设计风格的 Firefox 主题，将 Firefox 标签页的样式打磨得和 Chrome 圆角标签页近乎一致。
  ...
  ![](https://images.icloudnative.io/uPic/2022-04-30-12-55-BuK4Wp.png)

+ [FlyingFox](https://github.com/akshat46/FlyingFox) : 我认为这是最精美的 Firefox 主题，这也是我目前正在使用的主题。

  ![](https://images.icloudnative.io/uPic/2022-04-30-13-00-ov5mOh.png)
...
+ [FirefoxCSS-Store](https://github.com/FirefoxCSS-Store/FirefoxCSS-Store.github.io) : 从名字就能看出来，这是一个 Firefox userchrome 主题商店，包含了各种主题任你挑选。
  ...
  ![](https://images.icloudnative.io/uPic/2022-04-30-13-03-wrA7kV.jpg)
...
+ [firefox-csshacks](https://github.com/MrOtherGuy/firefox-csshacks) : 这个仓库包含了各种特定的样式，其中 chrome 文件夹包含了 userChrome.css 的样式，content 文件夹包含了 userContent.css 的样式。
  ...
  ![](https://images.icloudnative.io/uPic/2022-04-30-13-16-8Jwi0L.jpg)

+ [FirefoxCSS on Reddit](https://www.reddit.com/r/FirefoxCSS/) : 这是全球最大的 Firefox 样式分享社区，你可以在这里自由讨论、提问、分享自己的样式，或者拿走别人的样式。

  ![](https://images.icloudnative.io/uPic/2022-04-30-13-23-JWJUmU.jpg)
...
<img style="width: 400px" src="https://images.icloudnative.io/uPic/2022-04-30-14-47-abcd.png" />

现在我们就可以编写自定义样式并实时调试了，方法很简单，点击上述 StyloaiX 图标，然后依次选择 〖New Style〗--> 〖Blank Style〗。

![](https://images.icloudnative.io/uPic/2022-04-30-16-06-qAN44a.png)

然后就会打开一个编辑器的界面。

![](https://images.icloudnative.io/uPic/2022-04-30-16-08-E2Tp1Q.png)

然后就可以在里面调试样式了。比如我想对扩展界面进行自定义，就可以选择〖New Style〗--> 〖For this page〗，打开编辑器后会自动帮你设置 CSS 样式的生效页面。

![](https://images.icloudnative.io/uPic/2022-04-30-16-13-uaTRnw.png)
...
![](https://images.icloudnative.io/uPic/2022-04-30-16-21-uZTpAs.png)

调试好了确认无误后，只需给该样式命名然后保存即可。

![](https://images.icloudnative.io/uPic/2022-04-30-16-24-Mtlr2g.png)

如果你临时不想用这个样式了，可以点击 StyloaiX 图标，然后直接点击样式名，就会取消选中该样式，前面的图标会从〖打✅的圆〗变成〖空心圆〗。

![](https://images.icloudnative.io/uPic/2022-04-30-16-32-XlKBk4.png)
...
![](https://images.icloudnative.io/uPic/2022-04-30-16-55-gFAgRB.png)
...
![](https://images.icloudnative.io/uPic/2022-04-30-17-15-S4d5cC.png)

现在你可以在同一个界面中管理所有的扩展，包括启用、禁用、设置、卸载等等。

![](https://images.icloudnative.io/uPic/2022-04-30-17-16-krpUNM.png)
...
<img style="width: 300px;" src="https://images.icloudnative.io/uPic/20200813101211.png" />
...
![](https://images.icloudnative.io/uPic/2022-04-30-19-07-3GQALg.png)
...
![](https://images.icloudnative.io/uPic/2022-04-30-19-22-1qRfTh.jpg)
