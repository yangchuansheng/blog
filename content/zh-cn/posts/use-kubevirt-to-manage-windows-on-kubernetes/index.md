...
categories: 
- cloud-native
img: https://images.icloudnative.io/uPic/20201126104701.png
---

最近我发现我的 `Kubernetes` 集群资源实在是太多了，有点浪费，不信你看：

![](https://images.icloudnative.io/uPic/20201113174212.jpg)
...
![](https://images.icloudnative.io/uPic/20201113233921.png)
...
![](https://images.icloudnative.io/uPic/20201113234247.png)
...
![](https://images.icloudnative.io/uPic/20201122173815.png)

② [TechBench by WZT](https://tb.rg-adguard.net/public.php)。该网站提供的是直链下载方式，可以用任意下载工具进行下载，比上面的网站方便多了，不过资源没有上面的网站丰富。

![](https://images.icloudnative.io/uPic/20201122174051.jpg)
...
![](https://images.icloudnative.io/uPic/20201122185926.png)

下面就是安装正常的安装步骤往下进行，到选择硬盘那一步的时候，你会发现没有一个硬盘可供使用，这时就需要安装 virtio 驱动了。

![](https://images.icloudnative.io/uPic/20201122190331.png)

不过不用担心，virtio 驱动已经被挂载进来了，直接点击**加载驱动程序**就可以安装驱动了：

![](https://images.icloudnative.io/uPic/20201122190505.png)

![](https://images.icloudnative.io/uPic/20201122190628.png)

安装好驱动后，硬盘就能正确显示了：

![](https://images.icloudnative.io/uPic/20201122194231.png)

下面就可以继续安装了。

![](https://images.icloudnative.io/uPic/20201122194711.png)

安装成功后会自动重启进行初始化设置，那个熟悉的“海内存知己，天涯若比邻”又回来了：

![](https://images.icloudnative.io/uPic/20201122195000.png)

设置完成后，进入系统，打开设备管理器，可以看到有几个未配置的设备。选择其中一个右键单击，然后选择“更新驱动程序”。

![](https://images.icloudnative.io/uPic/20201122202548.png)

选择“浏览我的电脑以查找驱动程序”。

![](https://images.icloudnative.io/uPic/20201122202658.png)

选择“CD 驱动器（E:）virtio-win-0.1.1”，然后点击确定。

![](https://images.icloudnative.io/uPic/20201122202755.png)

设备管理器将自动找到正确的驱动程序，不需要指定驱动程序的路径。

在提示符下，单击“安装”。

![](https://images.icloudnative.io/uPic/20201122203249.png)
...
![](https://images.icloudnative.io/uPic/20201122211440.png)

安装完之后打开应用，选择 **Add PC**：

![](https://images.icloudnative.io/uPic/20201122211718.png)

在 **PC name** 一栏中输入 `NodeIP+NodePort`，然后点击 **Add**。

![](https://images.icloudnative.io/uPic/20201122212017.png)

然后右击创建好的配置，选择 **Connect**：

![](https://images.icloudnative.io/uPic/20201122212258.png)

输入账号密码后就可以连接到 Windows 了。

![](https://images.icloudnative.io/uPic/20201122212610.jpg)
