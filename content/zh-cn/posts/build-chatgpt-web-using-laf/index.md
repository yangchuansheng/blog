...
- FaaS
categories: AI
img: https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-12-14-53-XgkLbO.png
meta_image: https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-12-14-52-2glypD.jpg
---
...
![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-18-22-YLijVo.png)

点击开发按钮进入开发页面。

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-18-26-NMoDbR.png)

在 NPM 依赖面板中点击右上角的 `+`：

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-09-23-29-wNbCOt.png)

然后输入 chatgpt 并回车进行搜索，选择第一个搜索结果，**保存并重启：**

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-09-23-30-ARz9Vu.png)

重启之后，自定义依赖项中便出现了 chatgpt。

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-09-23-35-WoQaDj.png)
...
![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-18-36-kyCtdE.png)

API Key 是通过环境变量 `CHAT_GPT_API_KEY` 传入的，所以我们还需要创建一个环境变量。点击左下角的设置图标：

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-18-38-ydsD8h.png)

依次选择「环境变量」--> 「新增环境变量」，输入环境变量的名称和值，然后点击「确定」，再点击「更新」，便会重启应用。

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-18-46-Hr7VTk.png)

现在点击右上角的「运行」，即可调试运行。

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-18-49-44vRN2.png)
...
![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-18-53-Vavw0w.png)
...
![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-12-14-27-POTJQZ.png)
...
![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-19-09-hMcqZu.jpg)
...
![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-19-11-EE5Ld4.jpg)

上传完毕之后，发现右上角有一个 “开启网站托管”，点一下它！

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-19-11-N0Ty0Z.jpg)

点完之后出来一个链接，我们点击一下访问看看是啥东西。

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-19-12-iBZITq.jpg)

**哦！我的老天鹅呀 这不就是我刚刚开发的项目吗？？**

![](https://cdn.jsdelivr.net/gh/yangchuansheng/imghosting5@main/uPic/2023-03-11-19-12-bFGfCz.jpg)
