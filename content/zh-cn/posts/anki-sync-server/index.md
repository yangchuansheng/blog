...
img: https://images.icloudnative.io/uPic/2022-04-10-14-21-uFy94B.jpg
---

![](https://images.icloudnative.io/uPic/2022-04-10-14-07-WURNlT.png)
...
![](https://images.icloudnative.io/uPic/2022-04-10-10-52-H2ZWUZ.png)
...
![](https://images.icloudnative.io/uPic/2024-01-02-20-43-L7tjlP.png)

部署成功后，可以看到应用的运行情况，包括 CPU 占用、内存占用等。外网地址就是同步服务器的公网域名。

![](https://images.icloudnative.io/uPic/2023-06-26-13-09-YFHPYc.png)
...
1. 先打开「首选项」
   ...
   ![](https://images.icloudnative.io/uPic/2023-06-26-12-24-QHYKZt.png)

2. 点击「**网络**」，往下看，可以看到标有 `self-hosted sync server(自定义同步服务器)` 的方框，在里面填写您的服务端的地址：

   ![](https://images.icloudnative.io/uPic/2023-06-26-12-26-HYOaBJ.png)

3. 重启 Anki，然后点击「**同步**」：

   ![](https://images.icloudnative.io/uPic/2023-06-26-12-28-ccnUOj.png)

4. 这时候会弹出一个输入框让你输入用户名和密码，你需要将你之前设置的用户名和密码输入进去：

   ![](https://images.icloudnative.io/uPic/2023-06-26-12-29-z5E9gi.png)
...
<img style="width: 400px;" src="https://images.icloudnative.io/uPic/2022-04-10-14-31-vrNHJU.png">
...
<table><tr>
<td><img style="width: 400px;" src="https://images.icloudnative.io/uPic/2022-04-10-14-32-ADfk8T.png"></td>
<td><img style="width: 400px;" src="https://images.icloudnative.io/uPic/2022-04-10-14-32-1iudM0.png"></td>
</tr></table>
...
<img style="width: 400px;" src="https://images.icloudnative.io/uPic/2023-06-26-12-39-1jsF0t.jpeg">
...
<img style="width: 200px;" src="https://images.icloudnative.io/uPic/00022-1916295141.jpg">
