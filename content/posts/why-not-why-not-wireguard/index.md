...
![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@second/img/5db8bb9127604b2c30f4db71b729567b.gif)
...
![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@second/img/hub-and-spoke-single.svg)
...
![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@second/img/hub-and-spoke-multiple.svg)

WireGuard 就比较先进了，它支持**点对多点**架构，同一个客户端可以同时连接多个 `peer`，而不是只连接一个 `peer`，再通过该 peer 将流量转发到其他客户端。

![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@second/img/hub-and-spoke-direct.svg)
