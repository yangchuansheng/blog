...
![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163214.png)
...
![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163215.png)
...
![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163216.png)
...
![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163217.png)
...
![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163218.png)

如果系统中运行的是 Kubernetes，`machine.slice` 就变成了 `kubepods`：

![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163219.png)

为了便于管理 cgroup，`systemd` 会为每一个 `slice` 创建一个子系统，比如 docker 子系统：

![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163220.png)

然后再根据容器的设置，将其放入相应的控制器下面，这里我们关心的是 `cpuset` 控制器，看看它的目录下有啥：

![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163221.png)

查看 docker 目录：

![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@master/img/20200723163222.png)
