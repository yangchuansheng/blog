...
categories: 
- cloud-native
img: https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@second/img/20201207155224.jpg
---
...
- 选择操作系统和安装包，并单击【SEARCH】搜寻驱动，选择要下载的驱动版本
  ...
  ![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@second/img/20201204003108.png)
...
- 验证 使用如下命令验证是否安装成功 `nvidia-smi` 如果输出类似下图则驱动安装成功。
  ...
  ![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@second/img/20201204003306.png)
...
+ 下载对应版本如下图
  ...
  ![](https://jsd.onmicrosoft.cn/gh/yangchuansheng/imghosting@second/img/20201204003439.png)
